...
| [**SORTH**](https://github.com/RodrigoUC/SORTH) |  Desktop application for automatic academic timetable generation using a Greedy algorithm with retries, soft preferences, and SQLite session persistence.  | Python · PyQt6 · SQLite · pandas · openpyxl |
---
