...
| [**SORTH**](https://github.com/RodrigoUC/SORTH) |  Desktop application for automatic academic timetable generation using a Greedy algorithm with retries, soft preferences, and SQLite session persistence.  | PyQt6 · SQLite · pandas · openpyxl |
---
